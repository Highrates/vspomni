    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto max-sm:px-2 px-8 py-6 space-y-3">
          ...
          <div className="flex py-3 max-sm:px-3 px-4 border justify-between items-center rounded-full cursor-pointer hover:bg-neutral-50 transition">
            <h2 className="font-semibold">Добавить промокод или сертификат</h2>
            <Image src="/plus.svg" alt="arrow" width={30} height={30} />
          </div>
        </div>
        ...
        <div className="max-sm:p-4 p-8 border-t border-black/10 shrink-0">
          ...
          <Button className="w-full justify-center" onClick={checkout}>
