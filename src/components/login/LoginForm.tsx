  ...
  return (
    <div className="space-y-8">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-full font-medium transition-colors duration-200 bg-[#FFCC00] text-black hover:bg-[#FFD633] cursor-pointer"
      >
