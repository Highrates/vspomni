...
export default function NewsCard({ date, title, shortText, imageUrl, articleUrl }: NewsCardProps) {
  return (
    <div className="w-full overflow-hidden grid grid-rows-[200px_auto] sm:grid-rows-[240px_auto] lg:grid-rows-1 lg:grid-cols-[200px_auto] border border-borderdarkgrey rounded-xl">
